//
//  DetailViewController_2.swift
//  Dribble
//
//  Created by 王笛 on 16/8/24.
...
class DetailViewController_2: UIViewController {
    ...
    func quitScene() {
        ...
        func createOneImageView(index: Int) -> UIImageView {
            ...
            //点击手势
            let tap = UITapGestureRecognizer(target: self, action: #selector(DetailViewController_2.tapPanGesture(_:)))
            imageView.addGestureRecognizer(tap)
            
            //滑动手势
            let pan = UIPanGestureRecognizer(target: self, action: #selector(DetailViewController_2.panPanGesture(_:)))
