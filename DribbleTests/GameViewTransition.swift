//
//  GameViewTransition.swift
//  Dribble
//
//  Created by 王笛 on 16/8/31.
//  Copyright © 2016年 王笛iOS.Inc. All rights reserved.
//

import UIKit

class GameViewTransition: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        let fromVC = transitionContext.viewControllerForKey(UITransitionContextFromViewControllerKey) as! GameViewController
