...
public class Device {
    ...
    static private func getType(code code: String) -> DeviceTypes {
        ...
        switch versionCode {
            ...
            "iPhone8,1",
            "iPhone8,2",
            "iPhone8,4":                                    return DeviceTypes.iPhone
            ...
            "iPad5,1", "iPad5,2",
            "iPad6,3", "iPad6,4", "iPad6,7", "iPad6,8":     return DeviceTypes.iPad
            ...
            "iPod5,1",
            "iPod7,1":
                                                            return DeviceTypes.iPod
            case "i386", "x86_64":                          return DeviceTypes.Simulator
            default:                                        return DeviceTypes.Unknown
        }
    }
    ...
    static public func type() -> DeviceTypes {
        let versionName = Device.getVersionCode()
